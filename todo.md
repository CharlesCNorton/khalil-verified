...
14. Formalize maqṭūʿa as a relaxed qaṣīda (optional matlaʿ, 2–5 lines).
15. Add `Extraction` directives for core computable functions to OCaml or Haskell.
16. Build an extracted test harness against classical Arabic verse transcriptions.
