...
14. Add `Extraction` directives for core computable functions to OCaml or Haskell.
15. Build an extracted test harness against classical Arabic verse transcriptions.
