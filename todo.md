...
1. Generalize mutaḥarrik-modifying lemmas (`iḍmār_preserves_morae`, `waqṣ_reduces_morae`, `ʿaṣb_preserves_morae`, etc.) to pattern-general forms analogous to `delete_sakin_preserves_count`.
